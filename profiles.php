		...
		<div class="row">
			...
			<div class="profiles">	
				<div class="large-6 columns">
					<img src="img/USD/USD.jpg"/>
						<h6>University of San Diego</h6>
						
						<ul>
							<li>Student Leader: Kate Vosti</li>
							<li>Contact: kvosti@sandiego.edu</li>
							<li><a href="usdpics.php">Pictures</a></li>
							<li><a href="https://www.facebook.com/groups/isitusd" target="_blank"><i class="fi-social-facebook"></i></a></li>
						</ul>
