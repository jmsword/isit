...
<html class="no-js" lang="en">
  ...
  <body>
	...
	<div class="page-description">#FFE57F
		...
		<div class="row">
			...
			<div class="large-12 columns">
				...
				<span style="color:#FFE57F;">mindfulness</span>, <span style="color:#448DDC;">cultivating wisdom</span>, and <span style="color:#B8534C;">developing the 
				Heart</span>.</p> 
				
				<ul>
					<li><span style="color:#FFE57F;">Mindfulness</span> allows the students to become aware of their experience.</li> 
					<li><span style="color:#448DDC;">Wisdom</span> is cultivated through deepening an understanding of personal experience.</li> 
					<li>The <span style="color:#B8534C;">Heart</span> is developed through compassion training techniques based on Stanford’s <span style="font-style:italic;">Compassion Cultivation Training</span> as well as Kristen Neff and Christopher 
					Germer’s <span style="font-style:italic;">Mindful Self-Compassion</span>.</li>
				</ul>
				
				<p>What we are discovering is that students are noticing an impact in various aspects of their lives. Click on a category below to read experiences students 
				have shared. If you would like to share a personal testimony, please send us a comment from the <a href="contact.php">contact</a> page!</p>
				...
				<ul class="accordion" data-accordion>
					...
					<li class="accordion-navigation">
						...
						<div id="panel3a" class="content">
							...
							<p>“Self-compassion meditation has helped me be less critical of myself and accept my mistakes and my judgments as I go through life. I’m a perfectionist and 
					...
					<li class="accordion-navigation">
						...
						<div id="panel7a" class="content">
							<p><a href="contact.php">Contact</a> us to put your testimony here!</p>
						</div>
					</li>					
				</ul>
